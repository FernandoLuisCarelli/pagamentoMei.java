...
public final class WebServiceCep {
    ...
    public static WebServiceCep searchCep(JTextField cep1) {
...
/* M?todos e variaveis estaticas, respons?veis pela busca do CEP */
    /**
     * M
     * ascara para a string url de conex?o, onde <tt>"%s"</tt> ? substituido pelo valor
     * do cep. 
     */
	...
	public static WebServiceCep searchCep(String cep) {
		...
		try {
			...
			loadCep.setExceptio(ex);
			loadCep.setResultText("Erro inesperado. hahahaha");
